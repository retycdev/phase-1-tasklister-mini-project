  ...
  createTaskForm.addEventListener("submit", (e) => {
    ...
    if (tskDescrptn.value === "") {
      ...
      for (let [name, value] of formData) {
        ...
        editTsk.style.height = "40px";
        editTsk.style.padding = "0 24px";
        editTsk.style.width = "auto";
        editTsk.style.textAlign = "center";
        editTsk.innerHTML = "Edit";

        //delete icn styles
        deleteTsk.style.border = "1px solid black";
        deleteTsk.style.height = "40px";
        deleteTsk.style.padding = "0 24px";
        deleteTsk.style.width = "auto";
        deleteTsk.style.textAlign = "center";
        deleteTsk.innerHTML = "Delete";
